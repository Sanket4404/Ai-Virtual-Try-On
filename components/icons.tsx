...
export const GarmentIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
        viewBox="0 0 24 24" 
        ...
        className={className}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.375 21v-5.25m11.25 5.25v-5.25m-11.25 0L12 12l5.625 3.75M21 16.5c0-1.875-1.313-3.469-3-3.938V9.75a3 3 0 0 0-3-3h-6a3 3 0 0 0-3 3v2.812C4.313 13.031 3 14.625 3 16.5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3Z" />
    </svg>
);
...
export const LandscapeIcon: React.FC<{ className?: string }> = ({ className }) => (
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
        <rect x="3" y="6" width="18" height="12" rx="2" ry="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const SquareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
        <rect x="4.5" y="4.5" width="15" height="15" rx="2" ry="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export const RefreshIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.664 0M2.985 19.644l3.182-3.182m0 0-3.182 3.182m7.49-11.664a8.25 8.25 0 1 0 0 11.664 8.25 8.25 0 0 0 0-11.664Z" />
    </svg>
);
